    ...
    .controller('MainCtrl', [
      ...
      function(
        ...
        $scope.postData = function postData() {
          ...
          contractSrvc
            .startProcess(processId, userId, jsonifiedDataToSend)
        ...
        var onPostError = function(response) {
          ...
          $scope.message = response.data.explanations
        ...
        $scope.getExample = function(input) {
          var examples = {
            ...
            OFFSETDATETIME:
              $filter('date')(new Date(), 'yyyy-MM-ddTHH:mm', 'UTC') + 'Z'
          };

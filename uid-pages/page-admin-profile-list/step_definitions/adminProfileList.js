...
when("I type {string} in the group selection input", (selectedValue) => {
    cy.get('.modal .form-group input').eq(1).should('be.visible').type(selectedValue);
});
...
when("The search input is filled with {string}", (searchTerm) => {
    cy.get('.modal-body .form-group input').eq(1).should('be.visible').type(searchTerm);
});

when("The mapped membership search input is filled with {string}", (searchTerm) => {
    cy.get('.modal-body .form-group input').eq(2).should('be.visible').type(searchTerm);
});

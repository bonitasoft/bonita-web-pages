...
then("The done task details have the correct information", () => {
    ...
    cy.contains('.text-muted p.text-left', 'ID: 3');
    ...
    cy.contains('.panel-primary .link-height a', 'PublishDailyMeal (1.0)').should('have.attr', 'href', '/bonita/apps/APP_TOKEN_PLACEHOLDER/admin-process-details?id=5637856552961874995');
    cy.contains('.panel-primary .dl-horizontal dd','Publish daily meal by mail for all the team');
    ...
    cy.contains('.panel-primary .link-height a', 'RootProcessName (1.0)').should('have.attr', 'href', '/bonita/apps/APP_TOKEN_PLACEHOLDER/admin-process-details?id=5637856552961874994');
    cy.contains('.panel-primary .dl-horizontal dt','Root process display name');
    cy.contains('.panel-primary .dl-horizontal dd','Root process display name');
...
then("The executedBy information is displayed correctly when executedBySubstitute is undefined", () => {
    ...
    cy.contains('.panel-primary .dl-horizontal dd','Walter Bates');
    cy.contains('.panel-primary .dl-horizontal dt','Process name (version)');
    cy.contains('.panel-primary .link-height a', 'PublishDailyMeal (1.0)').should('have.attr', 'href', '/bonita/apps/APP_TOKEN_PLACEHOLDER/admin-process-details?id=5637856552961874994');
    cy.contains('.panel-primary .dl-horizontal dt','Process display name');
    cy.contains('.panel-primary .dl-horizontal dd','Publish daily meal by mail for all the team');
    cy.contains('.panel-primary .dl-horizontal dt','Case Id');

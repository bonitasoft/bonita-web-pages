Feature: Form case overview
  ...
  Scenario: The case overview shows the correct archived case IDs
    ...
    And The archived case "30003" context server response is defined
    And The archived case "30003" document server response is defined
  ...
  Scenario: The case overview shows the correct open case ID
    ...
    And The open case "30004" document server response is defined
